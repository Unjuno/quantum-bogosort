...
**Type:** repository-review simulation figure for E2. **Source:** `data/processed/qbs_nonlinear_minimal_mock_summary.csv`, metric `corr_score_luck`. The interaction-capable evaluator retains positive predictive alignment as noise rises, while the misspecified linear and random controls remain near zero.
