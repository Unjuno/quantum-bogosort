...
\frac{\delta}{5}.
\]
A union bound over the five target variables gives simultaneous coverage at least $1-\delta$. The resulting intervals are exactly the S2.8 inputs, so S2.8 yields
\[
