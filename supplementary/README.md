...
- [`prospective_recognition_protocol.md`](prospective_recognition_protocol.md) — prospective longitudinal protocol with past-adapted predictions, externally assigned exposure, preregistered sequential scoring, policy-versus-innovation separation, and explicit attrition/selection controls;
