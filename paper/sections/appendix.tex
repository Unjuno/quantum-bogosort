...
\]
For the downweighting interpretation take $0<\lambda\le1$. For the derivative identity at a fixed positive $\lambda_0$, assume $V$ is considered on an open positive neighborhood of $\lambda_0$ and that differentiation may be interchanged with numerator and denominator expectations there; in particular require the relevant weighted quantities
\[
